                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12  card p-2">
                                ...
                                ?>
                                <form action="<?=site_url('Roles/addRole')?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <input type="text" name="roleName" class="form-control" placeholder="Type Here Role..">
                                            </div>
                                            <div class="col-lg-2">
                            ...
                            <hr>
                               <table class="table table-hover">
                                   <thead class="thead-light">
                                       ...
                                       <th class="text-center font-weight-bold">Role Name</th>
