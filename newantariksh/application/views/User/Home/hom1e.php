                  ...
                  <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default" id="panel1">
                      <div class="panel-heading" data-toggle="collapse" data-target="#collapse1">
                        <h4 class="panel-title"><a data-toggle="collapse" data-target="#collapse1" href="#collapse1">Subscriber Statistics</a></h4>
                      </div>
             ...
             <div class="card-body">
               <div class="panel panel-default" id="panel2" data-toggle="collapse" data-target="#collapse2">
                  <div class="panel-heading" data-toggle="collapse" data-target="#collapse2">
                    <h4 class="panel-title"><a data-toggle="collapse" data-target="#collapse2" href="#collapse2" class="collapsed">Tickets</a></h4>
                  </div>
                  <div id="collapse2" class="panel-collapse collapse fade">
                    <div class="panel-body">
                       <table class="table table-striped table-hover ">
                            ...
                            <tbody>
                                <tr>
                                    <td>Number Of Active Tickets</td>
                                    <td>655</td>
                                ...
                                <tr>
                                    <td>Number Of Closed Ticket</td>
                                    
                                    <td>923</td>
                                </tr>
                                <tr>
                                    <td>Number Of Active Tickets (Today)</td>
...
<div class="row">
        ...
        <div class="card" >
            <div class="card-body">
              ...
              <div class="panel-heading" data-toggle="collapse" data-target="#collapse3">
                <h4 class="panel-title"><a data-toggle="collapse" data-target="#collapse3" href="#collapse3" class="collapsed">Billings</a></h4>
              </div>
              <div id="collapse3" class="panel-collapse collapse  fade">
                        <div class="panel-body">
                          <table class="table table-striped table-hover ">
                            ...
                            <tbody>
                                <tr>
                                    <td>Today's Payment(s)</td>
                                    <td>655</td>
                                    
                                </tr><tr>
                                    <td>Yesterday's Payment(s)</td>
                                    
                                    <td>923</td>
                                </tr>
                                <tr>
                                    <td>Current Month Payment(s)</td>
                                    
                                    <td>268</td>
                                    
                                </tr>
                                <tr>
                                    <td>Previous Month Payment(s)</td>
    ...
    <div class="col-lg-6 col-md-6">
        <div class="card" >
             <div class="card-body">
               <div class="panel panel-default" id="panel4" data-toggle="collapse" data-target="#collapse4">
                  <div class="panel-heading" data-toggle="collapse" data-target="#collapse4">
                    <h4 class="panel-title"><a data-toggle="collapse" data-target="#collapse4" href="#collapse4" class="collapsed">Reportings</a></h4>
                  </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <?php include"../template/setting_bar.php" ?>
</body>
