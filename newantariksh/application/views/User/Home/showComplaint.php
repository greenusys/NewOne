                           ...
                           <div class="card-body">
                               <table class="table table-hover">
                                   <thead class="thead-light">
                                       ...
                                       <th class="text-center font-weight-bold">Complaint</th>
                                       <!-- <th class="text-center font-weight-bold">Assigned On</th> -->
                                        ...
                                        foreach ($complaints as $comp ) {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?=$comp->complaint?></td>
                                                    <td class="text-center"><a href="javascript:void(0)" class="btn btn-info"><?=$comp->status?></a></td>
                                                </tr>
                                            <?php
                                            $i++;
                                        }
