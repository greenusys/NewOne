                  ...
                  <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default" id="panel1">
                      <div class="panel-heading" data-toggle="collapse" data-target="#collapse1">
                        <h4 class="panel-title"><a data-toggle="collapse" data-target="#collapse1" href="#collapse1"><i class="fas fa-file-alt"></i> Traffic Report</a></h4>
                      </div>

                      <div id="collapse1" class="panel-collapse collapse fade show">
                        <div class="panel-body">
                            <form action="<?=base_url('index.php/User/getTraficReport')?>" method="post">
                                <table class="table table-striped table-hover ">
                                    <tbody>
                                        <tr>
                                            <td class="float-right pt-4">Start Date</td>                                    
                                            <td><input type="date" class="form-control" name="satrt_time" placeholder="dd/dm/yy" value="<?php if(isset($_POST['satrt_time'])){echo $_POST['satrt_time'];}?>"></td>   
                                            <td></td>
                                            <td class="float-right pt-4">Start Date</td>
                                            <td><input type="date" class="form-control" value="<?php if(isset($_POST['end_time'])){echo $_POST['end_time'];}?>" placeholder="dd/dm/yy"  id="end_time" name="end_time" ></td>  
              ...
              <div id="collapse3" class="panel-collapse collapse fade show">
                        ...
                        <?php if (!empty($report)) : 
                            ...
                            foreach($report as $row) :?>
                                ...
                                $totalTransaction += $row['uploads'] + $row['downloads'];
                                ?>
                                <tr>
                                    <td><?php echo $p ;?></td>
                                    ...
                                    <td><?= $row['starttime'] ?></td>
                                    <td><?= !empty($row['endtime']) ? $row['endtime'] : date('Y-m-d h:i:s');?></td>
                                    <td><?= $row['duration'] ?></td>
                                    <td><?= $row['downloads'] ?></td>
                                    <td><?=$row['uploads'] ?></td>
                                    <td><?= $row['uploads'] + $row['downloads'] ?></td>
                                    <td><?= $row['reason'] ?></td>
                                </tr>
                                    <?php 
                                    $p++;
                                ...
                                <tr>
                                    ...
                                    <th><?= $totalUploads ?></th>
                                    <th colspan="4"><?= $totalTransaction?></th>
                                </tr>

                            <?php else: ?>     
                                <tr>
                                    <td colspan="15" align="center" valign="middle">no bill found for the selected month and year!</td>
                                </tr>
                            <?php endif; ?>
                            </tbody>
                          </table>
