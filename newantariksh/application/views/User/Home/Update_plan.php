   ...
   <br>
    <div class="row d-flex justify-content-center">
            <div class="card col-md-4" style="background: #0000000f;border-radius: 5px;">
                <div class="card-body">
                    <div align="center">
                        <span style="color: #29c218;"><?=$this->session->flashdata('success')?></span>
                    </div>
                    
                    <form method="POST" action="<?=base_url('index.php/User/planUpdate')?>">
                        <table class="table table-stripped  ">
                            <tbody>
                                <tr>
                                    <td><label>Current Pack</label><br>
                                        
                                        <input type="text"   value="<?=$userService->service_name?>" class="form-control" disabled>
                                        <input type="hidden"  name="currentPlan" id="currentPlan" value="<?=$userService->service_name?>" class="form-control" >
                                    </td>
                                
                                    <td><label>Select New Pack</label> 

                                        <select class="form-control" name="newService">
                                           ...
                                           // print_r($userService);
                                                ...
                                                foreach($services as $service)
                                                {
                                                    ...
                                                    if($service->service_id==$userService->service_id)
                                                    {
                         ...
                         <!-- <button class="btn btn-success" id="procd">Update Plan</button>    -->
                    </form>
