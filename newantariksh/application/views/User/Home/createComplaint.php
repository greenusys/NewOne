                ...
                <div class="row" id="divCreatePlan" >
                    <div class="col-lg-12">
                        <div class="card  p-5">
                            ...
                            ?>
                           <form action="<?=base_url('index.php/User/addComplaint')?>" method="post">
                               
                                   <div class="col-lg-12">
                                       <label>Complaint <span class="text-danger">*</span></label>
                                       <textarea type="text" name="Complaint" placeholder="Enter Your Complaint" class="form-control" required></textarea>
                                   </div>
       ...
       $(document).ready(function(){
           ...
           $('#createPlan').submit(function(e){
              ...
              // alert(dv);
               ...
               if(wht2Do=='create')
               {
                url="<?=base_url('index.php/Plan/insertNewPlan')?>";
               }
               else
               {
                url="<?=base_url('index.php/Plan/insertNewPlan/').$planId?>";
               }
