                            ...
                            <tbody>
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td><strong><?=$userData->user_type?></strong></td>
                                    <!-- <td>923</td> -->
                                </tr>
                                 <tr>
                                    <td>Status</td>
                                    
                                    <td><strong><?=$userData->user_status?></strong></td>
                                    <!-- <td>923</td> -->
                                </tr>
                                 <tr>
                                    <td>Static IP</td>
                                    
                                    <td><strong><?=$userData->static_ip_new?></strong></td>
                                    <!-- <td>923</td> -->
                                </tr>
                                 <tr>
                                    <td>Allowed MAC address</td>
                                    
                                    <td><strong><?=$userData->mac_address?></strong></td>
                                    <!-- <td>923</td> -->
                                </tr>
                                 <tr>
                                    <td>Deposit</td>
                                    
                                    <td><strong><?=$userData->deposit?></strong></td>
                                    <!-- <td>923</td> -->
                                </tr>
             ...
             <div class="card-body">
               <div class="panel panel-default" id="panel2" data-toggle="collapse" data-target="#collapse2">
                  <div class="panel-heading" data-toggle="collapse" data-target="#collapse2">
                    <h4 class="panel-title"><a data-toggle="collapse" data-target="#collapse2" href="#collapse2" class="collapsed"><i class="fa fa-arrows"></i> Service data</a></h4>
                  </div>
                  <div id="collapse2" class="panel-collapse collapse fade show">
                    <div class="panel-body">
                       <table class="table table-striped table-hover table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><strong><?=$userService->service_name?></strong></td>
                                ...
                                <tr>
                                    <td>Next service change date:</td>
                                    <td><strong><?=date('d M Y', strtotime($userData->end_date))?></strong></td>
                                </tr>
                                <tr>
                                    <td>Scheduled service name:</td>
                                    <td><strong><?=$userNextService->service_name?></strong></td>
        ...
        <div class="card" >
            <div class="card-body">
              ...
              <div class="panel-heading" data-toggle="collapse" data-target="#collapse3">
                <h4 class="panel-title"><a data-toggle="collapse" data-target="#collapse3" href="#collapse3" class="collapsed"><i class="fa fa-user"></i> Personal Data</a></h4>
              </div>
                        ...
                        <div class="panel-body">
                          <table class="table table-striped table-hover table-bordered ">
                            ...
                            <tbody>
                                <tr>
                                    <td>First name</td>
                                    <td><strong><?=$userData->first_name?></strong></td>
                                </tr>
                                <tr>
                                    <td>Last name</td>
                                    <td><strong><?=$userData->last_name?></strong></td>
                                </tr>
                                <tr>
                                    <td>Address</td>
                                    <td><strong><?=$userData->address.','.$userData->city?></strong></td>
                                </tr>
                                <tr>
                                    <td>Country</td>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td>Phone</td>
                                    <td><strong><?=$userData->phone?></strong></td>
