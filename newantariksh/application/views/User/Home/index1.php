            ...
            <div class="card col-md-4" style="background: #0000000f;border-radius: 5px;">
                <div class="card-body" id="entr_no">
                      <h4>Enter your Registered Mobile No. or Customer ID</h4>
                        <div class="input-group" >
                            ...
                            <input type="text" class="form-control" placeholder="Registered Mobile No.:" aria-describedby="basic-addon1" name="user_name" required="">
                        </div><br>
                     <button class="btn btn-success" id="procd">Proceed</button>   
                </div>
                ...
                <div class="card-body" id="transactn_details" style="display: none">
                      <h4>Here is your payment details:</h4>
                        ...
                        <button class="btn btn-success" id="tran_procd">Proceed</button> 
                </div>
                ...
                <div class="card-body" id="confirm_pay" style="display: none">
                      <h4>Check Your Payment Details:</h4>
                        ...
                        <button class="btn btn-success" id="confrm_procd">Proceed</button> 
                </div>
            </div>
