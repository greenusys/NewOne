        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-av-timer"></i><span class="hide-menu">User </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                 ...
                                 <?php 
                                 if($perm[$i]==1){  ?>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Subscriber')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Show User </span></a></li>
                                <?php 
                                    }
                                 if($perm[$i]==2){  ?>
                                        <li class="sidebar-item"><a href="<?=base_url('index.php/Subscriber/create')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Add User </span></a></li>
                                <?php 
                                      } 
                                    }
                                ?>
                               <!--  <li class="sidebar-item"><a href="<?=base_url('index.php/Subscriber/show_leaseSubs')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Show Lease Subscriber</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Subscriber/create_lease')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Create Lease Subscriber</span></a></li>
                     ...
                     <!-- <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">Location</span></li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-collage"></i><span class="hide-menu">Location</span></a>
                            <ul aria-expanded="false" class="collapse first-level"> -->
                               <!--   <li class="sidebar-item"><a href="<?=base_url('index.php/Location')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Country </span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Location/state')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">State</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Location/city')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">City </span></a></li>
                                 <li class="sidebar-item"><a href="<?=base_url('index.php/Location/area')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Area</span></a></li> -->
                                <!-- <li class="sidebar-item"><a href="<?=base_url('index.php/Location/loc')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Location</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Location/building')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Building</span></a></li> -->
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-collage"></i><span class="hide-menu">Admin</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                            	<li class="sidebar-item"><a href="<?=base_url('index.php/Admin/role')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Roles </span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Admin/show_permission')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Permission </span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Admin/showEmployee')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Employee</span></a></li>
                               <!--  <li class="sidebar-item"><a href="<?=base_url('index.php/Admin/company')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Company</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Admin/franchise')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Franchise	</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Admin/partner')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Partner</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Admin/topup_f')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Franchise/Partner Topup</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Admin/master_misc')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Miscellaneous</span></a></li> -->
                             </ul>
                        </li>  
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-collage"></i><span class="hide-menu">Notification</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Notification/SmsTemplate')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> SMS Template</span></a></li>
                               
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Notification/EmailTemplate')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Email Template </span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Notification/PushAlert')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Push Alert</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Notification/taskStatus')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Task Status</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-image-filter-tilt-shift"></i><span class="hide-menu"> Plan</span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <!-- <li class="sidebar-item"><a href="<?=base_url('index.php/Plan')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Create Topup Plan</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/Plan/planAssign')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Plan Assign</span></a></li> -->
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-image-filter-tilt-shift"></i><span class="hide-menu"> System Setting</span></a>
                            <ul aria-expanded="false" class="collapse first-level"> -->
                               <!--  <li class="sidebar-item"><a href="<?=base_url('index.php/System_Setting')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Setting</span></a></li>
                                <li class="sidebar-item"><a href="<?=base_url('index.php/System_Setting')?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Server Info</span></a></li>
                                ...
                                <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-playlist-plus"></i> <span class="hide-menu">CP Management</span></a>
                                    <ul aria-expanded="false" class="collapse second-level">
                                        <li class="sidebar-item"><a href="<?=base_url('index.php/System_Setting/Banneroffer')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu">Banner & Offer</span></a></li>
                                    </ul>
                                </li> -->
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-border-none"></i><span class="hide-menu">Reports</span></a>
                             <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <!-- <li class="sidebar-item"> <a class="has-arrow sidebar-link" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-playlist-plus"></i> <span class="hide-menu">Accounts Report</span></a>
                                    <ul aria-expanded="false" class="collapse second-level">
                                        <li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Billreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Bill Report</span></a></li>
                                        <li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Renewalreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Miscellaneous Report </span></a></li>
                                        <li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Renewalreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> Profoma Invoice Report</span></a></li>
                                        <li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Renewalreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu">Collection Report</span></a></li>
                                    	<li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Renewalreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu">Subscriber Outstanding</span></a></li>
                                    	<li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Renewalreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu">Topupdeduction Report</span></a></li>
                                    	<li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Renewalreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu">Franchise Topup</span></a></li>
                                    	<li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Renewalreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu">Partner Topup</span></a></li>
                                    	<li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Renewalreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu">Online Fr/Pr Topup</span></a></li>
                                    	<li class="sidebar-item"><a href="<?=base_url('index.php/Accountreport/Renewalreport')?>" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu">Online Renewal Report</span></a></li>
                                    </ul>
                                </li> -->
